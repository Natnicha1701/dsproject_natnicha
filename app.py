...
# Homepage
if page == "Homepage":
    st.title("Welcome to see My Moodeng")
    st.image("https://s2.coinmarketcap.com/static/img/coins/200x200/33076.png", caption="Your Amazing Banner Image", use_column_width=True)
    st.write("""
...
# Contact Us
    ...
    st.write("- Email: natnicha170151@gmail.com")
    st.write("- ig: dxepblue")
